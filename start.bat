...
venv\Scripts\pip install -q PyYAML==5.3.1 beautifulsoup4 requests imageio matplotlib numpy==1.19.3 pandas==1.2.5 scikit-image scikit-learn imageio-ffmpeg tqdm
